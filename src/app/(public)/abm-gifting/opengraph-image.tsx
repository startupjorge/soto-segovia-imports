...
export const alt = "Spanish Gourmet Food Gifts for Account-Based Marketing | Soto & Segovia Imports";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ fontSize: 13, letterSpacing: "0.35em", textTransform: "uppercase", color: "#C9A227", marginBottom: 28, display: "flex" }}>
          Account-Based Marketing · Gifting
        </div>

        <div style={{ fontSize: 52, fontWeight: 700, color: "#FFFFFF", textAlign: "center", lineHeight: 1.2, maxWidth: 860, marginBottom: 24, display: "flex", flexDirection: "column", alignItems: "center" }}>
          <span>The ABM Tactic Your</span>
          <span>Competitors Are Not Running</span>
        </div>

        <div style={{ width: 60, height: 2, background: "#C9A227", marginBottom: 24, display: "flex" }} />

        <div style={{ fontSize: 19, color: "rgba(255,255,255,0.65)", textAlign: "center", maxWidth: 640, lineHeight: 1.5, marginBottom: 48, display: "flex" }}>
          Premium Spanish gourmet food gifts for B2B revenue teams targeting high-value accounts.
        </div>
