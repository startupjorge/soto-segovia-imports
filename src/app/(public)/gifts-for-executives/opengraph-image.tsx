...
export const alt = "Gifts for Executives | Premium Spanish Gourmet Foods | Soto & Segovia Imports";
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "#1A1A1A", fontFamily: "serif", position: "relative" }}>
        ...
        <div style={{ fontSize: 52, fontWeight: 700, color: "#FFFFFF", textAlign: "center", lineHeight: 1.2, maxWidth: 840, marginBottom: 24, display: "flex", flexDirection: "column", alignItems: "center" }}>
          <span>Gifts for Executives That</span>
          <span>Strengthen Every Relationship</span>
        </div>
        <div style={{ width: 60, height: 2, background: "#C9A227", marginBottom: 24, display: "flex" }} />
        <div style={{ fontSize: 19, color: "rgba(255,255,255,0.65)", textAlign: "center", maxWidth: 600, lineHeight: 1.5, marginBottom: 48, display: "flex" }}>
