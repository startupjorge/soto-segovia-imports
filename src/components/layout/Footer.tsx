  ...
  EN: {
    services: {
      ...
      links: [
        ...
        { label: "VIP Guest Gifts for Casinos", href: "/casino-gifting" },
    ...
    integrations: {
      ...
      links: [
        ...
        { label: "AI - Claude MCP", href: "/integrations/claude-mcp" },
        { label: "Developer API", href: "/api-reference" },
      ],
    },
  ...
  ES: {
    services: {
      ...
      links: [
        ...
        { label: "Regalos VIP para Casinos", href: "/casino-gifting" },
